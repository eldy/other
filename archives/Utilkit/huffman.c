//********************************************************************
// Compress/Uncompress a file using Huffman algorithm
//********************************************************************
...
#define EXTC  ".huf"
#define EXTC2 "huf"		// Must be EXTC without "."
#define EXTD  ".hud"
int i;
...
if (help) {
	...
	printf("\n");
	printf("%s is a simple compress/uncompress program using just the Huffman algorithm",PROG);
...
/* Cas de compression   */
/************************/
  printf("Compressing in progress...");
  strcpy(path2,path1);strcat(path2,EXTC);
  switch (Compression_Huffman(path1,path2)) {
...
/************************/
  ...
  switch (DeCompression_Huffman(path1,path2)) {
