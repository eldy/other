 ...
 *
 * $Id: mysql.lib.php3,v 1.1 2002/06/25 16:21:26 rodolphe Exp $
 * $Source: /cvsroot/firstjeudi/firstjeudi/htdocs/mysql.lib.php3,v $
 */
...
class Db {
  ...
  Function Db($host, $user, $pass) {
    ...
    $ret = $this->select_db("firstjeudi", $this->db);
    return $ret;
  }
  ...
  Function connect($host, $login, $passwd) {
	//print "host=$host login=$login passwd=$passwd";
